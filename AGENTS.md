...
This file is the working context for SplitIt. Keep it updated when architecture, routing, scripts, or conventions change. See [ai-context/specs/](ai-context/specs/) for detail docs.
...
├─ ai-context/      # Detail specs (architecture, auth, database)
